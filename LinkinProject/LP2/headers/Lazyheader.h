#ifndef __LAZYHEADER_H__
#define __LAZYHEADER_H__
...
//* Data structure to hold the online users
extern std::map<std::string, WebSocket*> onlineUsersDataBase;

#endif //__LAZYHEADER_H__